  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-12 md:py-16">
        {/* Use a responsive grid to keep perfect alignment across breakpoints */}
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Left: Heading, subtext, search, chips */}
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4 md:gap-3 lg:gap-4">
            {[
              ...
              <img
                ...
                alt={
                  i === 0
                    ? 'Temple wedding decor in Sri Lanka'
                    : i === 1
                    ? 'Jaffna catering and sweets'
